...
public class Generators {
	...
	// Returns a Hashmap that maps job indices to an ArrayList that contains the respective job size at index 0.
	// Job sizes are hyperexponentially distributed
	 private HashMap<Integer, ArrayList<Double>> getHyperexpJobs(int numJobs){
	...
	// Returns a Hashmap that maps each job to an ArrayList that contains the respective job size at index 0.
	// Job sizes are exponentially distributed
	private HashMap<Integer, ArrayList<Double>> getExpJobs(int numJobs){
	...
	// Returns a Hashmap that maps each job to an ArrayList that contains the respective job size at index 0 based on the specified job distribution
	public HashMap<Integer, ArrayList<Double>> getJobs(int numJobs, String jobDist){
		if (jobDist.equals("Exp")){
			return getExpJobs(numJobs);
		}
		else {
			return getHyperexpJobs(numJobs);
		}
	}
	...
	// Computes and returns a LinkedList of arrival times based on specified distribution type
